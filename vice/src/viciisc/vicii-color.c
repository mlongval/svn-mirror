...
{
    { 0x00 * 255.0f / 63.0f, 0x00 * 255.0f / 63.0f, 0x00 * 255.0f / 63.0f, 0x00, "Black"       },
    { 0x3f * 255.0f / 63.0f, 0x3f * 255.0f / 63.0f, 0x3f * 255.0f / 63.0f, 0x00, "White"       },
    { 0x2b * 255.0f / 63.0f, 0x0a * 255.0f / 63.0f, 0x0a * 255.0f / 63.0f, 0x00, "Red"         },
    { 0x18 * 255.0f / 63.0f, 0x36 * 255.0f / 63.0f, 0x33 * 255.0f / 63.0f, 0x00, "Cyan"        },
    { 0x2c * 255.0f / 63.0f, 0x0f * 255.0f / 63.0f, 0x2d * 255.0f / 63.0f, 0x00, "Purple"      },
    { 0x12 * 255.0f / 63.0f, 0x31 * 255.0f / 63.0f, 0x12 * 255.0f / 63.0f, 0x00, "Green"       },
    { 0x0d * 255.0f / 63.0f, 0x0e * 255.0f / 63.0f, 0x31 * 255.0f / 63.0f, 0x00, "Blue"        },
    { 0x39 * 255.0f / 63.0f, 0x3b * 255.0f / 63.0f, 0x13 * 255.0f / 63.0f, 0x00, "Yellow"      },
    { 0x2d * 255.0f / 63.0f, 0x16 * 255.0f / 63.0f, 0x07 * 255.0f / 63.0f, 0x00, "Orange"      },
    { 0x1a * 255.0f / 63.0f, 0x0e * 255.0f / 63.0f, 0x02 * 255.0f / 63.0f, 0x00, "Brown"       },
    { 0x3a * 255.0f / 63.0f, 0x1d * 255.0f / 63.0f, 0x1b * 255.0f / 63.0f, 0x00, "Light Red"   },
    { 0x13 * 255.0f / 63.0f, 0x13 * 255.0f / 63.0f, 0x13 * 255.0f / 63.0f, 0x00, "Dark Grey"   },
    { 0x21 * 255.0f / 63.0f, 0x21 * 255.0f / 63.0f, 0x21 * 255.0f / 63.0f, 0x00, "Medium Grey" },
    { 0x29 * 255.0f / 63.0f, 0x3e * 255.0f / 63.0f, 0x27 * 255.0f / 63.0f, 0x00, "Light Green" },
    { 0x1c * 255.0f / 63.0f, 0x1f * 255.0f / 63.0f, 0x39 * 255.0f / 63.0f, 0x00, "Light Blue"  },
    { 0x2d * 255.0f / 63.0f, 0x2d * 255.0f / 63.0f, 0x2d * 255.0f / 63.0f, 0x00, "Light Grey"  }
};
